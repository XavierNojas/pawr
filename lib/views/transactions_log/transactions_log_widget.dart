...
import 'transactions_log_model.dart';
export 'transactions_log_model.dart';
...
class TransactionsLogWidget extends StatefulWidget {
  ...
  @override
  State<TransactionsLogWidget> createState() => _TransactionsLogWidgetState();
}

class _TransactionsLogWidgetState extends State<TransactionsLogWidget>
    with TickerProviderStateMixin {
  late TransactionsLogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionsLogModel());
