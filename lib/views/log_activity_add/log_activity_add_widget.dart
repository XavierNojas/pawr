...
import 'log_activity_add_model.dart';
export 'log_activity_add_model.dart';

import 'package:paw_r_app/models/pet.dart';


class LogActivityAddWidget extends StatefulWidget {
  final Pet pet;
  const LogActivityAddWidget({Key? key, required this.pet}) : super(key: key);

  static String routeName = 'LogActivityAdd';
  static String routePath = '/logFood';

  @override
  State<LogActivityAddWidget> createState() => _LogActivityAddWidgetState();
}

class _LogActivityAddWidgetState extends State<LogActivityAddWidget>
    with TickerProviderStateMixin {
  late LogActivityAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LogActivityAddModel());
                      ...
                      Expanded(
                        child: Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                               await _model.addActivity(context, formKey, widget.pet);
                            },
                            text: 'Add Food',
