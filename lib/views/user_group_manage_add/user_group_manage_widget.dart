...
class UserGroupManageAddWidget extends StatefulWidget {
  const UserGroupManageAddWidget({Key? key}) : super(key: key);

  static String routeName = 'LogFoodAdd';
  static String routePath = '/logFood';

  @override
  State<UserGroupManageAddWidget> createState() => _UserGroupManageAddWidgetState();
}

class _UserGroupManageAddWidgetState extends State<UserGroupManageAddWidget>
    with TickerProviderStateMixin {
  late UserGroupManageAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserGroupManageAddModel());
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'Enter your friend\'s reference code.',
                        ...
                        //             16.0, 0.0, 16.0, 16.0),
                        //         child: TextFormField(
                        //           controller: _model.caloriesFieldTextController,
                      ...
                      Expanded(
                        child: Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                               await _model.findUser(context, formKey);
                            },
                            text: 'Confirm',
