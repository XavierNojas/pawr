...
import 'pet_add_model.dart';
export 'pet_add_model.dart';

import 'package:paw_r_app/models/pet.dart';

import 'package:paw_r_app/views/pet_profile/pet_profile_widget.dart';

class PetProfileAddWidget extends StatefulWidget {

  const PetProfileAddWidget({Key? key}) : super(key: key);

  static String routeName = 'PetProfileAdd';
  static String routePath = '/petProfileAdd';

  @override
  State<PetProfileAddWidget> createState() => _PetProfileAddWidgetState();
}

class _PetProfileAddWidgetState extends State<PetProfileAddWidget>
    with TickerProviderStateMixin {
  late PetProfileAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PetProfileAddModel());
