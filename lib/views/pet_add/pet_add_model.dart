...
import 'dart:ui';
import '/index.dart';
import 'pet_add_widget.dart' show PetProfileAddWidget;
...
class PetProfileAddModel extends FlutterFlowModel<PetProfileAddWidget> {
...
// determines if value is close to whole number
  ...
  Future<void> addNewPet(BuildContext context, GlobalKey<FormState> _formKey) async {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      try {
        await Provider.of<PetViewModel>(context, listen: false).addPet(addPet);
        ...
        // do something
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Pet Profile Added!')),
        );
      }
