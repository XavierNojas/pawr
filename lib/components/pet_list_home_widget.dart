import 'package:paw_r_app/components/pet_list_home_model.dart';
import 'package:paw_r_app/views/pet_profile/pet_profile_widget.dart';
import 'package:paw_r_app/views/pet_transact/pet_transact_widget.dart';
...
class _PetListHomeWidgetState extends State<PetListHomeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PetListHomeModel());
