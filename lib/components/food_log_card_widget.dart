...
import 'food_log_card_model.dart';
export 'food_log_card_model.dart';
...
class FoodLogCardWidget extends StatefulWidget {
  const FoodLogCardWidget({
    super.key,
  ...
  @override
  State<FoodLogCardWidget> createState() => _FoodLogCardWidgetState();
}

class _FoodLogCardWidgetState extends State<FoodLogCardWidget>
    with TickerProviderStateMixin {
  late FoodLogCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FoodLogCardModel());
                        ...
                        Flexible(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 8.0, 0.0),
                            child: Text(
                              'Amount: ${widget.amount}  |  Calories: ${widget.calories}  |  GL:${widget.glycemic}',
